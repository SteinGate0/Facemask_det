...
from impl.utils.torch_utils import init_seeds as init_torch_seeds
from impl.utils.torch_utils import is_parallel
...
def check_img_size(img_size, s=32):
    # Verify img_size is a multiple of stride s  # 验证img_size是stride s 的倍数
...
def make_divisible(x, divisor):
    # Returns x evenly divisble by divisor  返回能被除数整除的x
